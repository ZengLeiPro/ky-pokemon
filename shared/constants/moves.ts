...
export const MOVES: Record<string, Move> = {
  ...
  flamethrower: { id: 'flamethrower', name: '喷射火焰', type: 'Fire', category: 'Special', power: 90, accuracy: 100, ppMax: 15, description: '喷射烈焰攻击对手。有时会让对手陷入灼伤状态。' },
  fireBlast: { id: 'fireBlast', name: '大字爆炎', type: 'Fire', category: 'Special', power: 110, accuracy: 85, ppMax: 5, description: '用大字形的火焰烧尽对手。有时会让对手陷入灼伤状态。' },
  surf: { id: 'surf', name: '冲浪', type: 'Water', category: 'Special', power: 90, accuracy: 100, ppMax: 15, description: '利用大浪攻击自己周围所有的宝可梦。' },
  ...
  sludgeBomb: { id: 'sludgeBomb', name: '污泥炸弹', type: 'Poison', category: 'Special', power: 90, accuracy: 100, ppMax: 10, description: '将污泥投掷对手进行攻击。有时会让对手陷入中毒状态。' },
  rollout: { id: 'rollout', name: '滚动', type: 'Rock', category: 'Physical', power: 30, accuracy: 90, ppMax: 20, description: '在5回合内连续滚动攻击对手。每次命中威力就会提高。' },
  spark: { id: 'spark', name: '电光', type: 'Electric', category: 'Physical', power: 65, accuracy: 100, ppMax: 20, description: '将带电的身体撞向对手进行攻击。有时会让对手陷入麻痹状态。' },
  ironTail: { id: 'ironTail', name: '铁尾', type: 'Steel', category: 'Physical', power: 100, accuracy: 75, ppMax: 15, description: '用坚硬的尾巴摔打对手进行攻击。有时会降低对手的防御。' },
  megahorn: { id: 'megahorn', name: '超级角击', type: 'Bug', category: 'Physical', power: 120, accuracy: 85, ppMax: 10, description: '用坚硬且华丽的角狠狠地刺向对手进行攻击。' },
  ...
  dazzlingGleam: { id: 'dazzlingGleam', name: '魔法闪耀', type: 'Fairy', category: 'Special', power: 80, accuracy: 100, ppMax: 10, description: '放出强烈的光芒攻击对手。' },
  rockSlide: { id: 'rockSlide', name: '岩崩', type: 'Rock', category: 'Physical', power: 75, accuracy: 90, ppMax: 10, description: '将大岩石猛砸向对手进行攻击。有时会使对手畏缩。' },
  earthquake: { id: 'earthquake', name: '地震', type: 'Ground', category: 'Physical', power: 100, accuracy: 100, ppMax: 10, description: '用地震的冲击攻击自己周围所有的宝可梦。' },
  signalBeam: { id: 'signalBeam', name: '信号光束', type: 'Bug', category: 'Special', power: 75, accuracy: 100, ppMax: 15, description: '发射神奇的光线进行攻击。有时会使对手混乱。' },
  flameWheel: { id: 'flameWheel', name: '火焰轮', type: 'Fire', category: 'Physical', power: 60, accuracy: 100, ppMax: 25, description: '让身上覆盖火焰突击对手进行攻击。有时会让对手陷入灼伤状态。' },
  feintAttack: { id: 'feintAttack', name: '出奇一击', type: 'Dark', category: 'Physical', power: 60, accuracy: 100, ppMax: 20, description: '悄悄地靠近对手，趁其不备进行攻击。攻击必定会命中。' },
  cottonSpore: { id: 'cottonSpore', name: '棉孢子', type: 'Grass', category: 'Status', power: 0, accuracy: 100, ppMax: 40, description: '将棉孢子紧贴在对手身上。大幅降低对手的速度。' },
  machPunch: { id: 'machPunch', name: '音速拳', type: 'Fighting', category: 'Physical', power: 40, accuracy: 100, ppMax: 30, priority: 1, description: '以迅雷不及掩耳之势出拳。必定能够先制攻击。' },
  petalDance: { id: 'petalDance', name: '花瓣舞', type: 'Grass', category: 'Special', power: 120, accuracy: 100, ppMax: 10, description: '在2～3回合内散落花瓣攻击对手。之后自己会陷入混乱。' },
