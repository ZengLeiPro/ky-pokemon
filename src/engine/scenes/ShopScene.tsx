          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <ShopItem name="经验糖果S" desc="给宝可梦喂下后，能获得800点经验值" price={500} accent="amber" onBuy={() => buyItem('exp-candy-s', 500, 1)} />
                  <ShopItem name="经验糖果M" desc="给宝可梦喂下后，能获得5000点经验值" price={2000} accent="amber" onBuy={() => buyItem('exp-candy-m', 2000, 1)} />
                  <ShopItem name="经验糖果L" desc="给宝可梦喂下后，能获得30000点经验值" price={8000} accent="amber" onBuy={() => buyItem('exp-candy-l', 8000, 1)} />
                </div>
              </div>
